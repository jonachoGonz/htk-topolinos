...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed right-5 z-50 w-14 h-14 bg-emerald-500 hover:bg-emerald-400 text-white rounded-full shadow-lg shadow-emerald-500/30 flex items-center justify-center transition-all hover:scale-105 active:scale-95"
